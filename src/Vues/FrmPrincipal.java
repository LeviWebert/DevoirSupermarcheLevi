...
public class FrmPrincipal extends javax.swing.JFrame {
    ...
    public void RemplirJtableRayon()
    {
        for(Rayon r: fm.GetAllRayonsByIdsecteur(Integer.parseInt(tblSecteurs.getValueAt(tblSecteurs.getSelectedRow(), 0).toString())))
        {
            v=new Vector();
            v.add(r.getIdRayon());
            v.add(r.getNomRayon());
    ...
    public void RemplirJtableEmployes()
    {
        for(Travailler t : fm.GetAllTravailler(Integer.parseInt(tblRayons.getValueAt(tblRayons.getSelectedRow(), 0).toString())))
        {
            v=new Vector();
    ...
    private void tblRayonsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblRayonsMouseClicked
        ...
        RemplirJtableEmployes();
        txtTotalHeuresRayon.setText(String.valueOf(fm.TotalHeuresRayon(Integer.parseInt(tblRayons.getValueAt(tblRayons.getSelectedRow(), 0).toString()))));
    ...
    private void btnModifierMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnModifierMouseClicked
        ...
        {
            JOptionPane.showMessageDialog(null,"Sélectionnez un rayon", "Choix du Rayon",JOptionPane.ERROR_MESSAGE);
        }
        else if(txtNouveauTemps.getText().compareTo("")==0)
        {
            JOptionPane.showMessageDialog(null,"Saisissez un temps", "Choix du temps",JOptionPane.ERROR_MESSAGE);
        }
        else
        {
    ...
    private void btnInsererTempsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnInsererTempsMouseClicked
        ...
        {
            fm.InsererTemps(fm.GetIdEmployeByNom((String) cboEmployes.getSelectedItem()), Integer.parseInt(tblRayons.getValueAt(tblRayons.getSelectedRow(), 0).toString()),Integer.parseInt(txtNouveauTemps.getText()) );
            while(dtmEmployes.getRowCount()!=0)
            {
                dtmEmployes.removeRow(0);
            }
